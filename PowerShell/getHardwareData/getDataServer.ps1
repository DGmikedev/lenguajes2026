...
# Usuarios y seguridad	        usuarios conectados, sesiones activas, permisos, antivirus, firewall
# Almacenamiento	            discos físicos, discos lógicos, RAID, espacio libre, rendimiento I/O
# Identificación del equipo	    UUID, serial del disco, nombre del host, dominio
# Eventos y logs	            Event Viewer, errores críticos, reinicios inesperados
# Actualizaciones	            parches instalados, Windows Update, reinicios pendientes
